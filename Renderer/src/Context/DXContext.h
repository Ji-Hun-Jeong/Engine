...
namespace Graphics
{
	...
	public:
		...
		~DXContext() 
		{
			...
			Device->CreateBuffer(&BufferDesc, &BufferData, VertexBuffer.GetAddressOf());
			...
			IndexCount = static_cast<UINT>(_Indices.size());
	...
	public:
		void Render()
		{
			...
			Context->DrawIndexed(_Resource->GetIndexCount(), 0, 0);
		}
